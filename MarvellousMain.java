...
class MarvellousLogin extends Template implements ActionListener,Runnable
{
	...
	MarvellousLogin()
	{
		...
		TopLabel.setText("Marvelleous Packer Unpacker:Login");
		...
		text2.setToolTipText("ENTER PASSWARD:");
		
		test2.addFocusListener(new FocusListener()
		{
	...
	public boolean Validate(String Username,String passward)
	{
		if(Username.length()<8||(passward.length()<8))
		{
			return false;
		}
		else
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==SUBMIT)
		{
			if(Validate(value1,value2)==false)
			{
				...
				JOptionPane.showMessageDialog(this,"Short username","Marvelleous Packer Unpacker",JOptionPane.ERROR_MESSAGE);
			}
			if(value1.equals("MarvelleousAdmin")&&value2.equals("MarvelleousAdmin"))
			{
			...
			else
			{
				...
				if(attempt == 0)
				{
					JOptionPane.showMessageDialog(this,"Number of attempts finished","Marvelleous Packer Unpacker",JOptionPane.ERROR_MESSAGE);
					this.dispose();
					System.exit(0);
				}
				JOptionPane.showMessageDialog(this,"Incorrct Login or Passward","Error",JOptionPane.ERROR_MESSAGE);
			}
		}
	}
}
